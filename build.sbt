...
//	"-Ylog-classpath",
//	"-Xlog-implicits",
	"-Wconf:cat=deprecation&msg=implementation artifact:silent,cat=deprecation&msg=foldLeft:silent,cat=deprecation&msg=foldRight:silent,cat=deprecation:w,cat=feature:w",
