...
import net.noresttherein.oldsql.sql.RowProduct.{GroundRow, NonEmptyRow, ProperSubselectOf, TopRow}
...
class CanSelectCheck {{
	...
	CanSelect[F, LabeledSQL[H, Grouped, IT]].returns[TopSelectAs[IndexedMapping.of[IT]#Mapping]]
	CanSelect[f.Self, LabeledSQL.EmptyListing.type].returns[TopSelectAs[IndexedMapping.of[@~]#Mapping]]
	CanSelect[S, LabeledSQL[U, Grouped, IT]].returns[SubselectAs[O, IndexedMapping.of[IT]#Mapping]]
	CanSelect[s.Self, LabeledSQL.EmptyListing.type].returns[SubselectAs[O, IndexedMapping.of[@~]#Mapping]]
	CanSelect[x.Self, LabeledSQL[Y, Grouped, IT]].returns[SelectAs[x.Base, IndexedMapping.of[IT]#Mapping]]
	CanSelect[x.Self, LabeledSQL[Y, Single, IT]].returns[SelectAs[x.Base, IndexedMapping.of[IT]#Mapping]]
	CanSelect[P, LabeledSQL[Q, Grouped, IT]].returns[SelectMapping[Params, IndexedMapping.of[IT]#Mapping]]
	CanSelect[p.Self, LabeledSQL.EmptyListing.type].returns[SelectMapping[Params, IndexedMapping.of[@~]#Mapping]]
