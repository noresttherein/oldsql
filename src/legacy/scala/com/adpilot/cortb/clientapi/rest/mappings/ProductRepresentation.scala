...
import com.adpilot.cortb.clientapi.prototype.repository.entities.Components.Country
...
import com.adpilot.cortb.clientapi.rest.items.ProductItem
...
object ProductRepresentation extends EntityRepresentation[ProductItem, Product] {
	...
	lazy val references = Seq(client, seq(_.campaigns, _.campaigns))
