...
import com.adpilot.cortb.clientapi.prototype.repository.entities.StatusType
...
//	}
	...
	implicit val creativeImageFormat :Format[CreativeImageItem] = map[Array[Byte], CreativeImageItem](CreativeImageItem, _.contents)
	...
	implicit lazy val tagKeyFormat :Format[TagKeyItem] = LazyFormat(Json.format[TagKeyItem])

	implicit val statusFormat = Json.format[StatusItem]
