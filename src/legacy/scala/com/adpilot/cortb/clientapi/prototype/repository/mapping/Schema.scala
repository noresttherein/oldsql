...
import com.adpilot.cortb.clientapi.prototype.repository.entities.Model.{HasId, IdRef, Id}
...
//		def id = column[Option[Id]]("id", O.PrimaryKey, O.AutoInc)
	...
	class Tags(val tag :ql.Tag, ownerName :String) extends IdTable[com.adpilot.cortb.clientapi.prototype.repository.entities.Tag](tag, ownerName+"_tags") {
//		def id = column[Option[Id]]("id", O.PrimaryKey, O.AutoInc)
