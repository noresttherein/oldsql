...
/** A Concept of assigning a value to a component of a last, either directly as a set clause of an update statement,
  ...
  *           and/or last `T`.
  * @tparam T the mapping of the last being updated/inserted to.
  * @tparam E the subject type of last `T`.
  * @tparam C the mapping of a subcomponent of the last `T` which is being set.
