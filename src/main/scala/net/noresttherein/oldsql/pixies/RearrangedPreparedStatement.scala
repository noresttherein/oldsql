...
private[pixies] class InjectionPreparedStatement(stmt :PreparedStatement, startOffset :Int, indices :Rearrangement,
...
private[pixies] class RearrangedPreparedStatement(stmt :PreparedStatement, startOffset :Int, indices :Rearrangement,
                                                  setNotExposedToNull :Boolean = false)
	extends PreparedStatementProxy
{
...
private[oldsql] object RearrangedPreparedStatement {
	def apply(stmt :PreparedStatement, startIndex :Int, indexing :Rearrangement, setUnmappedToNull :Boolean = false)
			:PreparedStatement =
	...
	def apply(stmt :PreparedStatement, indexing :Rearrangement) :PreparedStatement =
...
private[pixies] class InjectionCallableStatement private[pixies](stmt :CallableStatement,
                                                                 startOffset :Int, indexing :Rearrangement)
...
private[oldsql] class RearrangedCallableStatement private (stmt :CallableStatement,
                                                           startOffset :Int, indices :Rearrangement)
...
private[oldsql] object RearrangedCallableStatement {
	def apply(stmt :CallableStatement, startIndex :Int, indexing :Rearrangement) :CallableStatement =
	...
	def apply(stmt :CallableStatement, indexing :Rearrangement) :CallableStatement =
...
//		RearrangedCallableStatement(stmt, startIndex, Rearrangement.sliced(gaps, indexRange))
//
//	def sliced(stmt :CallableStatement, gaps :IndexedSeq[(Int, Int)], indexRange :Int) :CallableStatement =
//		RearrangedCallableStatement(stmt, 1, Rearrangement.sliced(gaps, indexRange))
//
//	def permutation(stmt :CallableStatement, startIndex :Int, permutation :IndexedSeq[Int]) :CallableStatement =
//		RearrangedCallableStatement(stmt, startIndex, Rearrangement.permutation(permutation))
//
//	def permutation(stmt :CallableStatement, permutation :IndexedSeq[Int]) :CallableStatement =
//		RearrangedCallableStatement(stmt, 1, Rearrangement.permutation(permutation))
//
//	def inverse(stmt :CallableStatement, permutation :IndexedSeq[Int]) :CallableStatement =
//		RearrangedCallableStatement(stmt, 1, Rearrangement.inverse(permutation))
}
