...
import net.noresttherein.oldsql.schema.forms.{CustomColumnWriteForm, CustomOptColumnWriteForm, DerivedMappedColumnWriteForm, DerivedOptMappedColumnWriteForm, LazyColumnWriteForm, MappedColumnWriteForm, OffsetColumnWriteForm, OptMappedColumnWriteForm, SQLForms, UnspecifiedColumnForm}
...
object ColumnWriteForm {
	...
	def evalOpt[T :ColumnWriteForm](value: => Opt[T], text :String = null) :ColumnWriteForm[Any] =
		new EvalSQLWriteForm[T](value, Opt(text)) with IgnoringColumnWriteForm { outer =>
			override def notNull :ColumnWriteForm[Any] =
				new EvalSQLWriteForm[T](value, text) with IgnoringColumnWriteForm with NotNullWriteForm[Any] {
