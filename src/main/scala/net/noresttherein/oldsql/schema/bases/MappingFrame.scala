...
import net.noresttherein.oldsql.schema.Buff.{AutoInsert, AutoUpdate, BuffType, FilterPreset, Ignored, InsertPreset, NoFilter, NoFilterByDefault, NoInsert, NoInsertByDefault, NoSelect, NoSelectByDefault, NoUpdate, NoUpdateByDefault, OptionalSelect, ReadOnly, SelectPreset, UpdatePreset}
