...
/** A mixin trait for any interface `Self` we might want to decorate, aware what its decorator is.
  ...
  * implementation on property [[net.noresttherein.oldsql.morsels.Decorable.self self]]. This object can be then passed
  ...
  * function is passed as an argument to [[net.noresttherein.oldsql.morsels.Decorable.decorate decorate]] method
  ...
  * @see [[net.noresttherein.oldsql.morsels.Decorable.AbstractDecorable]]
  * @see [[net.noresttherein.oldsql.morsels.Decorable.Decorator]]
...
trait Decorable[Self] { this :Self =>
	...
	/** Create a copy of yourself, with a new decorator/decorators on top of the decorator stack.
	  ...
	  * of this object, with any existing decorators so that [[net.noresttherein.oldsql.morsels.Decorable.self self]]
	  ...
	  * @see [[net.noresttherein.oldsql.morsels.Decorable.redecorate]]
	  */
	...
	/** Discards any current decorators and wraps the underlying, bottom $Self instance in the decorator(s)
	  * created by the argument function. As with [[net.noresttherein.oldsql.morsels.Decorable.decorate decorate]],
	  * result's [[net.noresttherein.oldsql.morsels.Decorable.self self]] property is equal to the returned object itself.
	...
	/** [[net.noresttherein.oldsql.morsels.Decorable.redecorate Redecorates]] the underlying instance
	  ...
	  * is the same as [[net.noresttherein.oldsql.morsels.Decorable.undecorated undecorated]].
	  * @return `this.`[[net.noresttherein.oldsql.morsels.Decorable.undecorate undecorate]]`(identity)`.
	  */
	...
	/** [[net.noresttherein.oldsql.morsels.Decorable.redecorate Redecorates]] the underlying instance
	  ...
	  * The difference from [[net.noresttherein.oldsql.morsels.Decorable.redecorate redecorate]] is that decorators
	  * do not simply delegate the call to the [[net.noresttherein.oldsql.morsels.Decorable.Decorator.decorated decorated]]
	  ...
	  * [[net.noresttherein.oldsql.morsels.Decorable.undecorate undecorate]] called for some decorator
	  ...
	  * @return [[net.noresttherein.oldsql.morsels.Decorable.redecorate redecorate]]`(`[[net.noresttherein.oldsql.morsels.Decorable.redecoration redecoration]]` andThen decorator)`.
	  */
	...
	/** Discards all decorators wrapping the underlying $Self instance, if any. The returned object is a copy
	  ...
	  * with its [[net.noresttherein.oldsql.morsels.Decorable.self self]] property equal to itself.
	  * @return [[net.noresttherein.oldsql.morsels.Decorable.redecorate redecorate]]`(identity)`.
	  */
	...
	/** The bottommost $Self, unwrapped from all decorators. This does not create a new, undecorated instance
	  * like [[net.noresttherein.oldsql.morsels.Decorable.undecorated undecorated]], but simply returns the one
	  * referenced by the [[net.noresttherein.oldsql.morsels.Decorable.Decorator decorator]] chain, so
	  * [[net.noresttherein.oldsql.morsels.Decorable.self self]] property of the returned $self is also the exact same
	...
	/** The function applied to the bottommost instance in order to produce the final $Self
	  * [[net.noresttherein.oldsql.morsels.Decorable.self self]]: `this.self eq this.decorations(this.undecorated)`
	  */
	def decorations :Self => Self

	/** The decoration function up to this instance and no more. If this is the outermost $Self,
	  * it is the same as [[net.noresttherein.oldsql.morsels.Decorable.decorations decorations]]. Bottommost instance
	  * returns identity, and [[net.noresttherein.oldsql.morsels.Decorable.Decorator decorators]] in between
	...
	/** Equality on $Self is defined as equality of their [[net.noresttherein.oldsql.morsels.Decorable.self self]]
	  * versions. The default implementation delegates to
	  * [[net.noresttherein.oldsql.morsels.Decorable.undecoratedEquals undecoratedEquals]], which compares
	...
	/** Delegates to [[net.noresttherein.oldsql.morsels.Decorable.undecoratedCanEqual undecoratedCanEqual]].
	...
	/** Compares for equality `this` with `that`, ignoring decorators on top.
	  ...
	  * $Self. This process ignores [[net.noresttherein.oldsql.morsels.Decorable.self self]] property:
	...
	/** Similar to [[net.noresttherein.oldsql.morsels.Decorable.undecoratedCanEqual undecoratedCanEqual]],
	  * subclasses should override this method instead of the actual
	  * [[net.noresttherein.oldsql.morsels.Decorable.canEqual canEqual]], as the latter will delegate to this method.
	  * @return `getClass == that.getClass`, unless overridden.
	  */
	def undecoratedCanEqual(that :Self) :Boolean = getClass == that.getClass

	/** Hash code compatible with [[net.noresttherein.oldsql.morsels.Decorable.undecoratedEquals undecoratedEquals]],
	  * that is ignoring [[net.noresttherein.oldsql.morsels.Decorable.self self]] property.
	  */
...
object Decorable {
	...
	/** Base class for decorable, bottom $Self implementations. It leaves
	  * [[net.noresttherein.oldsql.morsels.Decorable.AbstractDecorable.redecorate redecorate]] method for subclasses
	  * to implement as their copy constructor. Does not implement any sort of specific equality.
	  * @param decorations a constructor function for [[net.noresttherein.oldsql.morsels.Decorable.self self]]:
	  *                    it accepts the bottom implementation (`this`) as an argument, and wraps it in a sequence
	  *                    of zero or more decorators.
	  * @see [[net.noresttherein.oldsql.morsels.Decorable.BaseDecorable]]
	  */
	...
	{ this :Self =>
		...
		/** Composes the given decorator constructor with whatever the existing decorating function is
		  ...
		  * @return [[net.noresttherein.oldsql.morsels.Decorable.BaseDecorable.redecorate redecorate]]`(this.decorators andThen decorator)`.
		  */
		...
		/** A copy constructor of this class: creates a new instance of the same type, and with the same parameters
		  * as this object, but with its [[net.noresttherein.oldsql.morsels.Decorable.BaseDecorable.self self]] property
	...
	/** A full implementation of a 'bottom' `Decorable`, requiring only mixing in an implementation of $Self.
	  ...
	  * but allows [[net.noresttherein.oldsql.morsels.Decorable.Decorator decorators]] to equal this class
	  * if they so choose by deferring the equality check to their
	  * [[net.noresttherein.oldsql.morsels.Decorable.undecoratedEquals undecoratedEquals]] method.
	  * @param decorations a constructor function for [[net.noresttherein.oldsql.morsels.Decorable.self self]]:
	  *                    it accepts the bottom implementation (`this`) as an argument, and wraps it in a sequence
	  *                    of zero or more decorators.
	...
	{ this :Self =>
		/** Creates a copy `twin` of this instance, preserving all its properties,
		  * but with [[net.noresttherein.oldsql.morsels.Decorable.self self]] property equal to `decorator(twin)`.
		  ...
		  *         of [[net.noresttherein.oldsql.morsels.Decorable.BaseDecorable BaseDecorable]].
		  */
	...
	/** Base interface for decorators of `Self`, that is implementations of `Self` which delegate to another instance
	  ...
	  * to the [[net.noresttherein.oldsql.morsels.Decorable.Decorator.decorated decorated]] instance, unless noted.
	  */
	trait Decorator[Self <: Decorable[Self]] extends Decorable[Self] { this :Self =>
		...
		/** Same as [[net.noresttherein.oldsql.morsels.Decorable.Decorator.decorated decorated]]`.`[[net.noresttherein.oldsql.morsels.Decorable.underlying underlying]]. */
		...
		/** A copy constructor: creates and returns a new instance of the same class and with same parameters
		  ...
		  * This is not a recursive method and does ''not'' return [[net.noresttherein.oldsql.morsels.Decorable.self self]],
		...
		/** Delegates to [[net.noresttherein.oldsql.morsels.Decorable.Decorator.decorated decorated]]`.`[[net.noresttherein.oldsql.morsels.Decorable.redecorate redecorate]].  */
		override def redecorate(decorator :Self => Self) :Self = decorated.redecorate(decorator)

		/** Invokes `decorated.`[[net.noresttherein.oldsql.morsels.Decorable.undecorate undecorate]]`(this.`[[net.noresttherein.oldsql.morsels.Decorable.Decorator.decorate decorate]]` andThen decorator)`. */
		override def undecorate(decorator :Self => Self) :Self =
			decorated.undecorate((decorate :Self => Self) andThen decorator)

		/** Invokes `decorated.`[[net.noresttherein.oldsql.morsels.Decorable.undecorate undecorate]]`(this.`[[net.noresttherein.oldsql.morsels.Decorable.Decorator.decorate decorate]]`)`. */
		override def undecorate :Self = decorated.undecorate(decorate)

		/** Returns `decorated.`[[net.noresttherein.oldsql.morsels.Decorable.decorations decorations]]. */
		override def decorations :Self => Self = decorated.decorations

		/** Returns `decorated.`[[net.noresttherein.oldsql.morsels.Decorable.redecoration redecoration]]` andThen `[[net.noresttherein.oldsql.morsels.Decorable.Decorator.decorate decorate]]. */
...
//	}
	...
	/** A base class for [[net.noresttherein.oldsql.morsels.Decorable.Decorator Decorator]] implementations
	  * which wrap another instance of $Self. Aside from implementing
	  * [[net.noresttherein.oldsql.morsels.Decorable.Decorator.decorate decorate]] with the function passed
	...
	/** Creates a new zipper pointing ''after'' `decorable.`[[net.noresttherein.oldsql.morsels.Decorable.self self]]. */
...
//		}
	...
	/** A zipper is an immutable object allowing traversal of a [[net.noresttherein.oldsql.morsels.Decorable Decorable]]
	  * stack. It is able to split function `Decorable.`[[net.noresttherein.oldsql.morsels.Decorable.decorations decorations]]
	  * into constructors for individual [[net.noresttherein.oldsql.morsels.Decorable.Decorator decorators]]
	  ...
	  * `decorable.`[[net.noresttherein.oldsql.morsels.Decorable.self self]], no matter the `decorable` instance given
	  * as the argument. It can be rewound, 'unwrapping' the decorators,
	  * either [[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.<< one by one]]
	  * or [[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.|<< completely]] to the bottommost `Decorable`.
	  ...
	  * [[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.apply apply]]`()`.
	  * Of course, as a consequence of mutations, the decorator stack
	  * as reported by `this.`[[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.point point]]
	  ...
	  * and calls to [[net.noresttherein.oldsql.morsels.Decorable.decorate decorate]]
	...
	final class DecorationsZipper[Self <: Decorable[Self]] private[Decorable]
	                             (/** The `Decorable[Self]` instance this zipper is pointing at. */
	                              val point :Self,
	                              /** A constructor for a [[net.noresttherein.oldsql.morsels.Decorable.Decorator Decorator]]
	                                * applied directly on top of `point` if this zipper moves
	                                * [[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.>> forward]].
	                              ...
	                              val continuation :Option[DecorationsZipper[Self]])
	{
		...
		/** A function with decorations applied on top of the instance this zipper is pointing at.
		  ...
		  * `this.point.`[[net.noresttherein.oldsql.morsels.Decorable.redecoration redecoration]]` andThen this.decorations`
		  * is always equivalent to `this.point.`[[net.noresttherein.oldsql.morsels.Decorable.decorations decorations]].
		...
		/** True if this zipper points to the bottommost instance of the `Decorable` stack
		  ...
		  * It is defined as [[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.point point]]
		  * not being a [[net.noresttherein.oldsql.morsels.Decorable.Decorator Decorator]]
		  */
		...
		/** Applies all preceding and following decorators to the bottommost instance and returns its
		  * [[net.noresttherein.oldsql.morsels.Decorable.self self]] representative.
		  * Decorators preceding are defined here as the constructors of all
		  * [[net.noresttherein.oldsql.morsels.Decorable.Decorator Decorator]] instances stacked one on top of each other
		  * in `this.`[[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.point point]]
		  * The following decorators is the function
		  * `this.`[[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.decorations decorations]],
		  * that is a composition of the decorator constructor
		  * `this.`[[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.decoration decoration]] with
		  * those in all following `DecorationsZipper` instances
		  * in `this.`[[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.continuation continuation]].
		  * @return `this.point.`[[net.noresttherein.oldsql.morsels.Decorable.redecorate redecorate]]`(`[[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.|<< |<<]]`.decorations)`
		  */
		def apply() :Self = point.redecorate(|<<.decorations)

		/** Advances the zipper,
		  * returning its [[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.continuation continuation]].
		  */
		...
		/** Advances this zipper, wrapping its [[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.point point]]
		  * in the decorators, until `pred(this.point)` is true,
		  * or [[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.continuation continuation]] stack is empty.
		...
		/** Applies all decorator constructors ahead of this zipper,
		  * starting with `this.`[[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.decoration decoration]]
		  * and following with `this.`[[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.continuation continuation]].
		  * If the full decorator stack is empty
		  * (`this.`[[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.point point]]
		  * is not a [[net.noresttherein.oldsql.morsels.Decorable.Decorator Decorator]] and `continuation.isEmpty`),
		  * then simply this instance is returned and its `decoration` is an identity function.
		  * @see [[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.>>]]
		  */
		...
		/** Assumes that the `Decorable` instance immediately below this zipper,
		  * is a [[net.noresttherein.oldsql.morsels.Decorable.Decorator Decorator]] and unwraps it,
		  * creating a zipper pointing to
		  * `this.point.`[[net.noresttherein.oldsql.morsels.Decorable.Decorator.decorated decorated]], with the constructor
		...
		/** Unwraps `this.`[[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.point point]] from all
		  * wrapping [[net.noresttherein.oldsql.morsels.Decorable.Decorator decorators]], until the argument $Self
		  * is reached, pushing the constructors of every unwrapped `decorator` onto the
		  * [[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.continuation continuation]] stack.
		...
		/** Applies `this.`[[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.<< <<]] recursively,
		  * for as long as `pred(this.`[[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.point point]]`)`
		  * is true, or until `point` is not a [[net.noresttherein.oldsql.morsels.Decorable.Decorator Decorator]].
		  */
		def <<(pred :Self => Boolean) :DecorationsZipper[Self] = {
		...
		/** Moves the zipper all the way to the bottom `Decorable`, putting the constructors for all decorators
		  * in a zipper queue [[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.continuation continuation]].
		  * This method has no effect if `this.`[[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.point point]]
		  * is not a [[net.noresttherein.oldsql.morsels.Decorable.Decorator Decorator]].
		  * If the full decorator stack is empty
		  * (`this.`[[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.point point]]
		  * is not a [[net.noresttherein.oldsql.morsels.Decorable.Decorator Decorator]] and `continuation.isEmpty`),
		  * then this instance is returned,
		  * and its [[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.decoration decoration]]
		...
		/** Removes from the stack the decorator applied on top of
		  * `this.`[[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.point point]],
		  * that is `this.`[[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.decoration decoration]] constructor.
		  * If `this.`[[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.continuation continuation]] exists,
		...
		/** Removes from the stack the decorator to which this zipper points. After the operation,
		  * [[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.point point]] is the $Self instance decorated
		  * by `this.point`, while [[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.decoration decoration]]
		  * and [[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.continuation continuation]] remain the same.
		  * @throws UnsupportedOperationException
		  *         If `this.`[[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.point point]] is not
		  *         a [[net.noresttherein.oldsql.morsels.Decorable.Decorator Decorator]].
		  */
		...
		/** Unwraps the underlying $Self, removing all [[net.noresttherein.oldsql.morsels.Decorable.Decorator decorators]]
		  * below this zipper's [[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.point point]].
		...
		/** Replaces the [[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.decoration decoration]] following
		  * this zipper's [[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.point point]] with the given
		...
		/** Replaces all decorators on top of this zipper's
		  * [[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.point point]] with the given decorator(s).
		  ...
		  * every [[net.noresttherein.oldsql.morsels.Decorable.Decorator Decorator]], until either `this.point`
		  ...
		  * `decorators `[[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.inject_: inject_:]]` this.`[[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.>>-| >>-|]]
		...
		/** Replaces the decorator this zipper is pointing at.
		  * @return [[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.<< <<]]` `[[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.replace replace]]` decorators`.
		  */
		@throws[UnsupportedOperationException]("if this.point is not a Decorator.")
		...
		/** Replaces the constructors of all decorators below this zipper with the given function, while leaving
		  ...
		  * The [[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.poin point]] of the new zipper will be
		  * `decoration(`[[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.-<< -<<]]`.point)`, while
		  * `this.`[[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.decoration decoration]] and
		  * [[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.continuation continuation]] remain unchanged.
		  */
		...
		/** Replaces the $Self instance at the [[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.point point]]
		...
		/** Pushes the given decorator(s) into the stack directly above this zipper,
		  * between `this.`[[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.point point]] and
		  * `this.`[[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.decoration decoration]].
		  * This method works by applying `decoration(point)`, and then
		  * [[net.noresttherein.oldsql.morsels.Decorable.DecorationsZipper.<< rewinding]] through all of the decorators
		  * created by the function, until `this.point`,
		  * or a non [[net.noresttherein.oldsql.morsels.Decorable.Decorator Decorator]] instance is reached.
