...
import net.noresttherein.oldsql.sql.{Adjoin, AggregateClause, Aggregated, AndBy, AndFrom, By, DecoratedFrom, Dual, Expanded, From, FromClause, FromSome, GroupBy, GroupByClause, GroupParam, InnerJoin, Join, JoinLike, JoinParam, LeftJoin, OuterJoin, RightJoin, RowProduct, Subselect, ParamClause}
...
trait RowProductVisitor[Y] {
	...
	def param[L <: NonEmptyFrom, P[O] <: UnboundParam[S, O], S](param :L ParamClause P) :Y = expanded[L, P, S](param)
