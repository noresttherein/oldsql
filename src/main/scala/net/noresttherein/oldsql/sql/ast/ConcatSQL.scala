...
{
	override def universalForm :Opt[ColumnForm[String]] = Got(ColumnForm[String])
	override def selectForm    :ColumnReadForm[String] = ColumnForm[String]
	...
	protected override def effectiveForm(implicit spelling :SQLSpelling) :ColumnForm[String] = ColumnForm[String]
