...
/**
  ...
  */
private[oldsql] trait StatementProxy extends Statement {
...
private[oldsql] trait PreparedStatementProxy extends StatementProxy with PreparedStatement {
	protected override def statement :PreparedStatement
...
private[oldsql] trait CallableStatementProxy extends PreparedStatementProxy with CallableStatement {
	protected override def statement :CallableStatement
